            ...
            <form method="POST" action="includes/register.php" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="form_email" class="form-control" placeholder="Your Email *" name="email" required="required">
                    </div>
                    <div class="form-group">
                        <label for="form_res_address">Residential Address :</label>
                        <input id="form_res_address" type="text" name="res_address" class="form-control" placeholder="Please enter your residential address *" required="required" autofocus=""
                        pattern="[A-Za-z0-9]+$" title="Only characters and integers are accepted">
                    </div>
                    <div class="form-group">
                        <label for="form_res_contact">Residential Contact No :</label>
                        <input id="form_res_contact" type="number" name="res_contact" class="form-control" placeholder="Please enter your residential contact no" required="required" autofocus="">
                    </div>
                    <div class="form-group">
                        <label for="form_mob_contact">Mobile Contact No :</label>
                        <input id="form_mob_contact" type="number" name="mob_contact" class="form-control" placeholder="Please enter your mobile contact no" required="required" autofocus="">
                    </div>
                    <div class="form-group">
